...
public class StreamApiWithObjects {
    ...
    public static void main(String[] args) {
        ...
        List<User> orderByUsername = userList.stream()
                .sorted(Comparator.comparing(User::getUsername))
                .toList();

        List<User> usersAfter1990 = userList.stream()
                .filter(user ->
                                user.getDateOfBirth().isAfter(LocalDate.of(1990, 12, 31)))
        ...
        int pageNumber = 2;
        int pageSize = 6;
        int skippedElement = (pageNumber - 1) * pageSize;
